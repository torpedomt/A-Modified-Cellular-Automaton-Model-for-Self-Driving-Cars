...
cars_out=0;
cars_in=0;
cars_on1=0;cars_on2=0;cars_on3=0;cars_on4=0;cars_on5=0;
cars_on=0;
            ...
            if temp_cars(5,ii)==1 
                 ...
                 if temp_id(5,ii)==1
                    ...
                    if d<l && d_o>d && d_b>0 && rand(1)<p_c1
                        ...
                        if ii+temp_vv<=m
                            cars(5,ii+temp_vv)=1;
                            v(5,ii+temp_vv)=temp_vv;
                            id(5,ii+temp_vv)=temp_id(5,ii);
                        else
                            cars_out=cars_out+1;
                        end
                    end
                   ...
                   if d<l && d_o>d && d_b>1 && rand(1)<p_c2
                       temp_vv=min([temp_v(5,ii)+1,vmax,d_o]);
                        if ii+temp_vv<=m
                            cars(4,ii+temp_vv)=1;
                            v(4,ii+temp_vv)=temp_vv;
                            id(4,ii+temp_vv)=temp_id(5,ii);
                        ...
                        temp_vv=min([temp_v(5,ii)+1,vmax,d]);
                        if ii+temp_vv<=m
                            cars(5,ii+temp_vv)=1;
                            v(5,ii+temp_vv)=temp_vv;
                            id(5,ii+temp_vv)=temp_id(5,ii);
            ...
            if temp_cars(4,ii)==1
                 ...
                 if temp_id(4,ii)==1
                   ...
                   if  d<l && d_r>d && d_r_b>0 && d_o>d && d_b>0 && rand(1)<p_c2 
                        if rand(1)<0.5
                        temp_vv=min([temp_v(4,ii)+1,vmax,d_r]);
                        if ii+temp_vv<=m
                            cars(5,ii+temp_vv)=1;
                            v(5,ii+temp_vv)=temp_vv;
                            id(5,ii+temp_vv)=temp_id(4,ii);
